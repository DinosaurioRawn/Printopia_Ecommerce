        ...
        <div className='flex flex-col h-screen'>
            ...
            <main className='container flex-1 flex flex-col items-center gap-10'>
                ...
                <div className='border border-slate-200 w-full md:w-[600px] p-5 rounded-md space-y-3'>
                    ...
                    <p className='text-sm'>
                        Gracias por realizar tu compra en PrintopiaMx. Para
                    ...
                    <div className='space-y-0.5 text-sm'>
                        <p>BANCO SANTANDER</p>
                        <p>Razón Social: PrintopiaMx</p>
                        <p>RFC: CUGD9810144W4</p>
                        <p>Número de tarjeta: 5579083005304866</p>
                    </div>

                    <p className='text-sm'>
                        Una vez realizada la transferencia, comparte tu
                        comprobante a mx.printopia@gmail.com para procesarla
                        y hacerte la entrega de tu pedido a domicilio.
                    </p>
                </div>
                ...
                <div className='border border-slate-200 w-full p-5 rounded-md space-y-3 md:w-[600px]'>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <span className='font-semibold'>
                                {formatPriceToMXN(data.totalAmount)}
                            </span>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-2 gap-5'>
                        ...
                        <div className='flex flex-col text-sm'>
                            ...
                            <p>
                                Deposito bancario - {formatPriceToMXN(data.totalAmount)}
                            </p>
                        </div>
