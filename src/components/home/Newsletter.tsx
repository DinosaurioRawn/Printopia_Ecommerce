...
export const Newsletter = () => {
  return (
    <div className="relative bg-gray-500 text-white py-20">
      {/* Imagen de fondo */}
      {/* Pendiente subir imagen en carpeta public/img con el nombre img-newsletter */}
      <div className='absolute inset-0 bg-cover bg-center opacity-70 h-full' style={{backgroundImage: 'url(/img/...)'}}></div>

      {/* Contenido */}
      <div className="container z-10 relative p-5 md:p-0">
        <div className="w-full text-black bg-white p-12 space-y-5 md:w-[50%] lg:w-[40%]">
          <p className="text-xs font-medium">Suscribete y recibe novedades exclusivas</p>
          <p className='text-xs font-medium w-[80%] leading-5'>Introduce tu correo para recibir novedades. </p>
