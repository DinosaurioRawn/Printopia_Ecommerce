...
const headersVariants = ['Stock', 'Precio', 'Tamaño', 'Color', ''];
                ...
                {fields.map((field, index) => (
                    <div key={field.id}>
                        <div className='grid grid-cols-5 gap-4 items-center'>
                            ...
                            <input
                                type='text'
                                placeholder='10cm (Cortador y sello)'
                            ...
                            <div className='flex relative'>
                                {colorActive[index] && (
                                    <div className='absolute bg-stone-100 rounded-md bottom-8 left-10 p-1 w-[100px] h-fit space-y-2'>
                                        <input
                                            type='color'
